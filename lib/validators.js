...
function escapeHtml(str) {
  // Escape konten mentah sebelum dikirim ke Telegram parse_mode HTML
...
function sanitizeHostname(name) {
  // Nama/hostname VPS: huruf kecil, angka, dash. 3-20 karakter.
  // UpCloud menolak hostname huruf besar & dash di awal/akhir (HOSTNAME_INVALID).
  let n = String(name || '')
    .toLowerCase()
    .replace(/[^a-z0-9-]/g, '-')
    .replace(/-{2,}/g, '-')
